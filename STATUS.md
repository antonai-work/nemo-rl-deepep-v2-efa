# Acceptance Status — nemo-rl-deepep-v2-efa
...
NeMo-RL + DeepEP V2 training overlay (rides on Megatron Shape Y dispatcher). Validates 1 rollout step shape [64, 8192] in 9.45 s on Qwen3-30B-A3B over 2-pod EFA.
...
- Megatron rollout adapter
- 1-step rollout 9.45 s shape [64, 8192]
- probs_finite=True
